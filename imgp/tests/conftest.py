...
def img_paths():
    return [
        ...
        os.path.join(
            root, "..", "tests", "images", "frogs", "waters-g38a3c5715_640.jpg"
        ),
        os.path.join(root, "..", "tests", "images", "frogs", "frog-gdc7a17746_640.jpg"),
        os.path.join(
            root, "..", "tests", "images", "giraffes", "giraffe-ge696dba15_640.jpg"
        ),
        os.path.join(
            root, "..", "tests", "images", "giraffes", "giraffe-g2122926f3_640.jpg"
        ),
        os.path.join(
            root, "..", "tests", "images", "giraffes", "giraffe-g9b3e5ee1f_640.jpg"
        ),
    ]
